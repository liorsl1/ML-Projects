...
<i text-decoration: underline>The goal:</i> Train the model to last for an average time of 195 timesteps/ticks. or get to 500 ticks. (It will get both,yet the program
